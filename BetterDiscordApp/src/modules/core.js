...
Core.prototype.patchAttributes = async function() {
    ...
    .then(DiscordTag => {
        ...
        DiscordTag.default = function(props){
            ...
            } else if (props.user.id === "742743457784922174") { // @AaronDewes
                children.push(
                    BDV2.React.createElement(TooltipWrap, {color: "black", side: "top", text: "BetterLightcord Developer"},
    ...
    this.socialPatch = Utils.monkeyPatch(TabBar.prototype, "render", {after: (data) => {
        ...
        if (Anchor) {
            ...
            const newOne = function() {
                ...
                returnVal.props.children.push(
                    BDV2.React.createElement(TooltipWrap, {color: "black", side: "top", text: "BetterLightcord"},
                        BDV2.React.createElement(Anchor, {className: "bd-social-link "+socialModule1.link, href: "https://github.com/BetterLightcord/BetterLightcord", title: "Better Lightcord", target: "_blank"},
                            BDV2.React.createElement(LightcordLogo, {size: "16px", className: "bd-social-logo"})
                        )
                    )
                );
